  ...
  <div class="accordion-item">
    ...
    aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        ...
        about any HTML can go within the <code>.accordion-body</code>, though the transition does
        limit overflow.
      </div>
    </div>
  </div>
  ...
  <div class="accordion-item">
    ...
    aria-labelledby="headingThree" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        ...
        You can modify any of this with custom CSSor overriding our default variables.
